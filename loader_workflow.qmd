...
13. System Manager
14. Data Aggregator
15. Computer (Automated)
16. Field Assistant
17. Guide
18. Passive Observer
19. Land Owner
20. Not Specified/Unknown
...
Each plant observation is assigned a unique stratum identifier by concatenating the survey ID and stratum layer **(!!FIX!!)**. This links individual plant records to their vertical position in the vegetation structure (tree layer, shrub layer, herb layer, etc.)
...
### Final Loader Table
Two loader tables are generated:

1. **Strata Cover Data** (`strataCoverLT.csv`) contains species abundance information, including the plant name as recorded by the author, the cover percentage, and links to the survey observation and stratum definition.
