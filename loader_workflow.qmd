...
Disturbance data is extracted from `RAImpacts.csv` files, as well as the `LImpacts.csv` lookup table. Variable mappings are given below:

| Loader Table          | Source Data |
|-----------------------|-------------|
| ob_code               | SurveyID    |
| disturbance_type      | Impact type |
| disturbance_comment   | Other       |
| disturbance_intensity | Intensity   |
| disturbance_age       | N/A         |
| disturbance_extent    | N/A         |
