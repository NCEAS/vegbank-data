...
plots_2 <- read_csv(here(folder, 'RAPlots.csv')) %>% 
  mutate('locfixed' = NA) # missing a column present in RAReleve's RAPlots.csv
alt_plots_2 <- read_csv(here(folder, 'AltPlots.csv'))
impacts_2 <- read_csv(here(folder, 'RAImpacts.csv'))
alt_strata_2 <- read_csv(here(folder, 'AltStrata.csv'))
classification_2 <- read_csv(here(folder, 'RAClassification.csv'))
projects_2 <- read_csv(here(folder, "RAProjects.csv"))
